...
// @access Private
const exportTaskReports = async (req, res) => {
  try {
...
const exportUsersReports = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error exporting user reports", error: error.message });
  }
};

export { exportUsersReports, exportTaskReports };
